import {ThirdTitle,CardNews} from "../../Components"
export function News(){
    return(
        <>
        
        <ThirdTitle ThirdTitle="Noticias"/>
        <CardNews title ="Ortodoncia" 
        ...
        <CardNews title ="Diseño de Sonrisa" 
        ...
        <CardNews title ="Aclaramiento Dental" 
        ...
        <CardNews title ="Prótesis Dental" 
        ...
        <CardNews title ="Odontología Estetica" 
        ...
        <CardNews title ="Odontología General" 
